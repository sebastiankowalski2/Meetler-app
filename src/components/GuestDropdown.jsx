  ...
  return (
    <div className="absolute top-2 left-2 flex flex-col items-start">
      ...
      <button
        ...
        className={`w-full py-0.5 shadow-[0_0_10px_rgba(0,0,255,1),inset_0_0_50px_rgba(255,200,0,1)] border-2 border-blue-500 z-50 text-md font-bold text-black duration-200 -mt-4.5 origin-top ${isOpen ? 'cursor-pointer opacity-100 scale-100 translate-y-4' : 'translate-y-0 opacity-0 scale-95 pointer-events-none'}`}
