  ...
  return (
    <div className="absolute top-2 right-2 participants-dropdown">
      ...
      <ul
        ...
        className={`shadow-[0_0_10px_rgb(var(--color-primary-rgb)),inset_0_0_50px_rgb(var(--color-secondary-rgb))] border-2 border-primary z-50 text-md font-bold text-black w-full duration-200 origin-top -mt-4.5 ${isOpen ? 'opacity-100 scale-100 translate-y-4' : 'translate-y-0 opacity-0 scale-95 pointer-events-none'}`}
      >
