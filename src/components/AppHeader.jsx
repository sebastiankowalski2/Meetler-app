...
export default function AppHeader({ onLogoClick, spin = false, right }) {
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-3 sm:gap-40 px-3 sm:px-6 py-2.5 backdrop-blur-md bg-white/50 border-b border-white/60 shadow-[0_1px_0_rgba(0,0,0,0.03)]">
      <Link
        to="/"
        onClick={onLogoClick}
